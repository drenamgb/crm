...
<div id="container">   
    <div class="row col-lg-12">
         <ol class="breadcrumb">
            <li class="active">Relatório de Pagamentos Detalhados</li>
        </ol>
    </div>
    <div class="row col-lg-12">
        <form action="src/dao/procedure/select_report_vendas_comissao_detalhada.php" method="post">
            <div class="col-lg-2">
            ...
            <div class="col-lg-2">                
                <div class="col-lg-2">
                    <br>
                    <button type="submit" class="btn btn-info" title="Exportar">
