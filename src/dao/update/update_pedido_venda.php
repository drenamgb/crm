<?php
    ...
    $idPedido           =   filter_input(INPUT_POST,             "idPedido",    FILTER_DEFAULT);
    ...
    $numeroProposta           =   filter_input(INPUT_POST,       "numeroProposta",            FILTER_DEFAULT);
...
//     $sp = "call update_pedido_venda ('{$nome}',
//            '{$cpf}',
//            '{$rg}',
//            '{$orgaoEmissor}',
//            '{$sexo}',
...
try{    
    ...
    $stmt       =   $PDO->prepare("call update_pedido_venda ("
            . ":nome,"
            . ":cpf,"
            . ":rg,"
            . ":orgaoEmissor,"
    ...
    $stmt->bindParam(":numeroProposta",$numeroProposta);
